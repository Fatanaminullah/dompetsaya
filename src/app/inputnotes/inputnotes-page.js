...
class FinanceRecordsPage extends Component {
    ...
    componentDidUpdate(prevProps,prevState) {
        ...
        if(prevState.transaction !== this.state.transaction){
            this.filterCategory()
        }else if(prevState.date !== this.state.date || prevState.transactionTable !== 
            this.state.transactionTable || prevState.categoryTable !== this.state.categoryTable ||
        ...
        var data = this.props.report.filter(item => {
            ...
            if(
                ...
                return (
                    ...
                    item.notes.includes(this.state.searchNotes)
                    ) 
            }else if(isNaN(parseInt(this.state.categoryTable))){
